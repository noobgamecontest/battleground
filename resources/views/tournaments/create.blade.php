                ...
                <div class="card-body">
                    <form action="{{ route('tournaments.store') }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="slots" class="form-control {{ $errors->has('slots') ? 'is-invalid' : '' }}" id="slots" value="{{ old('slots') }}"/>
                                @if($errors->has('slots'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="opponents_by_match" class="form-control {{ $errors->has('opponents_by_match') ? 'is-invalid' : '' }}" id="opponents_by_match" value="{{ old('opponents_by_match') }}"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="winners_by_match" class="form-control {{ $errors->has('winners_by_match') ? 'is-invalid' : '' }}" id="winners_by_match" value="{{ old('winners_by_match') }}"/>
