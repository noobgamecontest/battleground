...
Route::middleware('admin')->group(function () {
    ...
    Route::get('tournaments/{tournament}/results', 'TournamentsController@getResults')->name('results.form');
    Route::post('tournaments/results/matches/{match}', 'TournamentsController@setResults')->name('results.post');
});
